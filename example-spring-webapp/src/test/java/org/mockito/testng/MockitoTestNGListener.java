 ...
 * TestNG, mocks are initialized before any TestNG method, either a <em>configuration
 *         method</em> (&#064;BeforeMethod, &#064;BeforeClass, etc) or a <em>test</em> method, i.e. mocks are
 * initialized once only once for each test instance.</li>
 * <li>
 * As mocks are initialized only once, they will be reset after each <em>test method</em>. See javadoc
