 ...
 * <ul>
 * <li>
 * Initializes mocks annotated with {@link org.mockito.Mock}, so that
 * <strong>explicit usage of
 * {@link org.mockito.MockitoAnnotations#initMocks(Object)} is not
 * necessary</strong>. <strong>Note :</strong> With TestNG, mocks are
 * initialized before any TestNG method, either a <em>configuration
 ...
 * <em>test method</em>. See javadoc {@link org.mockito.Mockito#reset(Object[])}
 * </li>
 * <li>
 ...
 * {@link org.mockito.MockitoAnnotations}
 * 
 * <pre class="code">
 * <code class="java">
...
public class MockitoTestNGListener implements IInvokedMethodListener {
	...
	public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
		if (hasMockitoTestNGListenerInTestHierarchy(testResult.getTestClass()
				.getRealClass())) {
